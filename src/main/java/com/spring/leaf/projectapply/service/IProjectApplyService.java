...
public interface IProjectApplyService {
	...
	// 사용자의 지원현황 얻어오기 요청
	ApplyVO applyGet(int projectNO, int userNO);
	...
	MyProjectApplyDetailVO myProjectApplyDetail(int userNO, int projectNO);
	...
	// 지원 취소 처리
	void applyCancel(int userNO, int projectNO);
