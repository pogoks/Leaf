...
<title>오신것을 환영합니다</title>
	...
	<!-- 관리자:프로젝트 통계 css -->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/admin-gein-chart.css">
		...
		<div class="admin-chart">
			...
			<div class="box2">
			  	<ul class="nav nav-tabs">
			  		<li class="btn1 active"><a href="#project1" data-toggle="tab"> 개발자 신규가입/탈퇴 현황 </a></li>
			...
			<div class="content-box">
				...
				<div class="tab-content">
			  		<div class="tab-pane fade in active" id="project1"><!-- 1번째--------------------------------------- -->
			  			...
			  			<div class="top-box">
							<span class="text1">[개발자 가입/탈퇴 현황 통계]</span>
						...
						<div class="table-box2">
							<label>2022년 개발자(개인) 월간 가입/탈퇴 수</label>
							<table border="0" class="table">
								<tr>
									<th>2022년</th>
			  		...
			  		<div class="tab-pane fade" id="project2"><!-- 3번째--------------------------------------- -->
			  			...
			  			<div class="top-box">
							<span class="text1">[개발자 별 프로젝트 지원 현황 통계]</span>
							<select class="dropdown">
