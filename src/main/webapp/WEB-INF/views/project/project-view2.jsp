      ...
      <div class="project-jiwon">
      	...
      	<c:choose>
      		...
      		<c:when test="${apply.commonCODE == 'SPT001'}">
      			<button type="button" id="btn-apply-spt001" class="btn" style="background: #4F5199; color: white;">지원 취소</button>
      		</c:when>
      	
      		<c:when test="${apply.commonCODE == 'SPT002'}">
      			<button type="button" id="btn-apply-spt002" class="btn" disabled style="background: #c7c7c7;">심사 진행 중</button>
      		</c:when>
      		
      		<c:when test="${apply.commonCODE == 'SPT003'}">
      			<button type="button" id="btn-apply-spt002" class="btn" disabled style="background: #c7c7c7;">최종합격 검토 중</button>
      		</c:when>
      		
      		<c:when test="${apply.commonCODE == 'SPT004'}">
      			<button type="button" id="btn-apply-spt002" class="btn" disabled style="background: #c7c7c7;">참여중</button>
      		</c:when>
      		
      		<c:when test="${apply.commonCODE == 'SPT005'}">
      			<button type="button" id="btn-apply-spt002" class="btn" disabled style="background: #c7c7c7;">불합격</button>
      		</c:when>
