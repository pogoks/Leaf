...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	                        ...
	                        <ul class="nav navbar-nav navbar-right">
	                          <ul class="nav navbar-nav navbar-right">
	                            <ul class="nav navbar-nav">
	                              ...
	                              <ul class="nav navbar-nav">
	                               <li><a href="<c:url value='/user/userRegist' />" id="btn-register">회원가입</a></li>
	                            </ul>
	...
	<!-- 일반회원 상단바 / 메뉴 -->
	<c:if test="${user != null && company == null && user.commonCODE == 'ADM001'}">
		<div id="navbar-wrapper">
	        <header>
	            <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	                <div class="container-fluid">
	                    ...
	                    <div id="navbar-collapse" class="collapse navbar-collapse">
	                        ...
	                        <ul class="nav navbar-nav navbar-right">
	                          <ul class="nav navbar-nav navbar-right">
	                            <ul class="nav navbar-nav">
	                               <li><a id="btn-user-logout" style="cursor: pointer;">로그아웃</a></li>
	                            </ul>
	                        ...
	                        <ul class="nav navbar-nav navbar-right">
	                          <ul class="nav navbar-nav navbar-right">
	                            <ul class="nav navbar-nav">
	                              ...
	                              <li class="dropdown">
	                                  <a class="dropdown-toggle" data-toggle="dropdown" href="#">관리
	                                      <span class="caret"></span>
	                                  </a>
	                                  <ul class="dropdown-menu">
	                                      <li><a href="#">내 정보</a></li>
	                ...
	                <div class="container-fluid">
	                    ...
	                    <div id="navbar-collapse" class="collapse navbar-collapse">
	                        ...
	                        <ul class="nav navbar-nav navbar-right">
	                          <ul class="nav navbar-nav navbar-right">
	                            <ul class="nav navbar-nav">
	                               <li><a id="btn-company-logout" style="cursor: pointer;">로그아웃</a></li>
	                            </ul>
	                ...
	                <ul id="sidemenu" class="sidebar-nav">
	                    ...
	                    <li>
	                        ...
	                        <ul id="submenu-3" class="panel-collapse collapse panel-switch" role="menu">
	                            ...
	                            <li><a href="#"><i class="fa fa-caret-right"></i>회사 소개서 관리</a></li>
	                        </ul>
	                    </li>
	                </ul>
	            </aside>            
